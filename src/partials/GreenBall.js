...
export default class RedBall extends Ball {
    ...
    constructor(radius, boardWidth, boardHeight, ballcolor, difficalty){
        ...
        super.ping = new Audio('public/sounds/pong-03.wav');
    ...
    reset() {
        ...
        this.vy = 0;
        this.vx = 0;
        while ((this.vy < 2 && this.vy >-2 )|| (this.vx <2&&this.vx>-2)) {
            this.vy = Math.random() * 9-4.5;
            // this.vx = Math.floor(Math.random() * 10 - 5);
            this.vx = Math.random() * 9-4.5;
        }
    }
    goal(player){
        player.score+=5;
    ...
    render(svg,p1,p2){
        ...
        circle.setAttributeNS(null, 'fill', 'rgba(0,255,0,0.5');
